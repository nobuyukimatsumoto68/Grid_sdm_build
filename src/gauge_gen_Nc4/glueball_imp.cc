...
public:
  ...
  static void SmearStapleSpatial(GaugeLorentz &Umu, const GaugeLorentz &Umu) {
  ...
  // for spatial nu
  //////////////////////////////////////////////////
  static void StapleSpatial(GaugeMat &staple, const GaugeLorentz &Umu, int mu) {
  ...
  static void StapleSpatial(GaugeMat &staple, const std::vector<GaugeMat> &U, int mu) {
    staple = Zero();

    for (int nu = 0; nu < Nd-1; nu++) { // make nu spatial idx
