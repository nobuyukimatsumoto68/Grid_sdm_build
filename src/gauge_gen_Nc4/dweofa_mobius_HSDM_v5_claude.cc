// v5 (062626): copy of v4 with the mixed-prec inner-CG iteration cap raised
//     MX_inner 1000 -> 10000. At m=0.01 the inner single-prec CG needs ~3000
//     iters; 1000 truncated it and forced extra double-prec outer restarts.
//     Only that one line differs from v4 (left commented in place). RNG handling
//     unchanged (continues from checkpoint as before).
// v3: 033024 sungwoo
...
//   SymanzikGaugeActionR Syzaction(MyParams.gauge_beta);
  ...
  const int MX_inner = 10000;  // raised 1000 -> 10000: at m=0.01 the inner single-prec CG needs ~3000 iters; 1000 truncated it and forced extra double-prec outer restarts (valence used 10000)
